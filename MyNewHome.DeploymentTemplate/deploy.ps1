...
# Register RPs
$resourceProviders = @("microsoft.cdn","microsoft.cognitiveservices","microsoft.documentdb","microsoft.insights","microsoft.keyvault","microsoft.storage","microsoft.web");
